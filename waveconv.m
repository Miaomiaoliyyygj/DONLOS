...
%     plot(cos_wave)
    ...
    window1 = single(gausswin(samples, 1/0.3));  
    window2 = single(gausswin(samples, 1/0.3));  
    virtual_wave_sin = sin_wave .* window1;
    virtual_wave_cos = cos_wave .* window2;
%     plot(virtual_wave_sin)
%     hold on;
%     plot(virtual_wave_cos)
